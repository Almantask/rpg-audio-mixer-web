...
Feature: Tag scene
  ...
  Scenario: Adding a predefined tag via Edit shows it on the card
  ...
  Scenario: Adding a custom tag via Edit shows it on the card
  ...
  Scenario: Adding multiple tags via Edit shows all on the card
  ...
  Scenario: Removing a tag via Edit hides it from the card
