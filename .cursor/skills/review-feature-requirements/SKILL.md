...
description: Review Gherkin feature files as product requirements for completeness, clarity, scope fit, gaps, and simplification options. Use when reviewing .feature acceptance criteria before implementation or when principal agents audit scenario coverage and intent.
---
